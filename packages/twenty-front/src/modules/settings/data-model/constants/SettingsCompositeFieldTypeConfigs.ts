...
export const SETTINGS_COMPOSITE_FIELD_TYPE_CONFIGS = {
  ...
  [FieldMetadataType.EMAILS]: {
    ...
    exampleValues: [
      {
        primaryEmail: 'tim@zowka.com',
        additionalEmails: [
          'tim@zowka.com',
          'timapple@zowka.com',
          'johnappletim@zowka.com',
        ],
      },
      {
        primaryEmail: 'jane@zowka.com',
        additionalEmails: ['jane@zowka.com', 'jane.doe@zowka.com'],
      },
      {
        primaryEmail: 'john@zowka.com',
        additionalEmails: ['john.doe@zowka.com'],
      },
    ],
    category: 'Basic',
  ...
  [FieldMetadataType.LINKS]: {
    ...
    exampleValues: [
      {
        primaryLinkUrl: 'zowka.com',
        primaryLinkLabel: '',
        secondaryLinks: [{ url: 'zowka.com', label: 'Zowka' }],
      },
      {
        primaryLinkUrl: 'github.com/elyamaniyous/zowka',
        primaryLinkLabel: 'Zowka Repo',
        secondaryLinks: [{ url: 'zowka.com', label: '' }],
      },
      {
