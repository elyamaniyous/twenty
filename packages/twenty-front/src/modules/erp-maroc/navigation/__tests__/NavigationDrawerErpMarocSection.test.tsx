...
describe('NavigationDrawerErpMarocSection', () => {
  ...
  it.each([
    ...
    [erpMarocPaths.salesOrders, 'Commandes clients'],
    ['/erp-maroc/sales-orders/order-123', 'Commandes clients'],
    ...
    [erpMarocPaths.customerReturns, 'Retours clients'],
    ...
    [erpMarocPaths.treasury, 'Trésorerie'],
    [erpMarocPaths.inventory, 'Stock'],
    [erpMarocPaths.fiscal, 'Fiscalité'],
    [erpMarocPaths.liasse, 'Liasse PCGM'],
    [erpMarocPaths.closing, 'Clôture'],
    [erpMarocPaths.payroll, 'Paie & RH'],
    [erpMarocPaths.approvals, 'Approbations'],
    [erpMarocPaths.accountingAssistant, 'Assistant comptable'],
    [erpMarocPaths.portal, 'Portail client'],
