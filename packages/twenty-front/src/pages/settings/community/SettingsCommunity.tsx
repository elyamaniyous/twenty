...
export const SettingsCommunity = () => {
  ...
  const communityLinks: SettingsCommunityLink[] = [
    {
      title: t`Partners`,
      description: t`Contact the Zowka team for implementation and customization.`,
      href: 'https://zowka.com',
      Icon: IconBriefcase,
      cardTitle: t`Browse partners`,
    },
    {
      title: t`Support`,
      description: t`Contact our team to get help and share feedback.`,
      href: 'mailto:support@zowka.com',
      Icon: IconMessage,
      cardTitle: t`Contact support`,
    },
    {
      title: t`Releases`,
      description: t`Check out our latest releases`,
      href: 'https://github.com/elyamaniyous/zowka/releases',
      Icon: IconTransform,
