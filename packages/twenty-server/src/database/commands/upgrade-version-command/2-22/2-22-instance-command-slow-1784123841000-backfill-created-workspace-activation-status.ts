...
@RegisteredInstanceCommand('2.22.0', 1784123841000, { type: 'slow' })
  ...
  implements SlowInstanceCommand
{
  ...
  async runDataMigration(dataSource: DataSource): Promise<void> {
    ...
    const [, affectedCount] = await dataSource.query(
    ...
    this.logger.log(
      `Backfilled ${affectedCount} subscription-less active workspace(s) to CREATED`,
    );
  }
