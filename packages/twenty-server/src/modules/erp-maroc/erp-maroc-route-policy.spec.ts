...
const requiredIdempotencyRoutes = new Set([
  ...
  `POST /hr-people/notifications/${id}/retry`,
  'POST /hr-people/job-openings',
  'POST /hr-people/candidates',
  'POST /hr-people/applications',
  `POST /hr-people/applications/${id}/interviews`,
  `POST /hr-people/applications/${id}/offers`,
  `POST /hr-people/applications/${id}/hire`,
  'POST /hr-people/skills',
  `POST /hr-people/employees/${id}/skills`,
  'POST /hr-people/training-courses',
  `POST /hr-people/training-courses/${id}/sessions`,
  `POST /hr-people/training-sessions/${id}/enrollments`,
  'POST /hr-people/certifications',
  `POST /hr-people/employees/${id}/certifications`,
  'POST /hr-people/review-campaigns',
  'POST /hr-people/reviews',
  `POST /hr-people/reviews/${id}/objectives`,
]);
...
const approvedRoutes = [
  ...
  [
    'PATCH',
    `/hr-people/change-requests/${id}/decision`,
    'hr-people.change-request.decision',
    hrPeopleMutationResultSchema,
  ],
  [
    'PATCH',
    `/hr-people/attestations/${id}/decision`,
    'hr-people.attestation.decision',
    hrPeopleMutationResultSchema,
  ],
  [
    'POST',
    `/hr-people/notifications/${id}/retry`,
    'hr-people.notification.retry',
    hrPeopleMutationResultSchema,
  ],
  [
    'POST',
    '/hr-people/job-openings',
    'hr-people.job-openings',
    hrPeopleMutationResultSchema,
  ],
  [
    'PATCH',
    `/hr-people/job-openings/${id}`,
    'hr-people.job-opening.detail',
    hrPeopleMutationResultSchema,
  ],
  [
    'POST',
    '/hr-people/candidates',
    'hr-people.candidates',
    hrPeopleMutationResultSchema,
  ],
  [
  ...
  [
    'PATCH',
    `/hr-people/applications/${id}`,
    'hr-people.application.detail',
    hrPeopleMutationResultSchema,
  ],
  [
    'POST',
    `/hr-people/applications/${id}/interviews`,
    'hr-people.application.interviews',
    hrPeopleMutationResultSchema,
  ],
  [
    'PATCH',
    `/hr-people/interviews/${id}`,
    'hr-people.interview.detail',
    hrPeopleMutationResultSchema,
  ],
  [
    'POST',
    `/hr-people/applications/${id}/offers`,
    'hr-people.application.offers',
    hrPeopleMutationResultSchema,
  ],
  [
    'PATCH',
    `/hr-people/offers/${id}`,
    'hr-people.offer.detail',
    hrPeopleMutationResultSchema,
  ],
  [
    'POST',
    `/hr-people/applications/${id}/hire`,
    'hr-people.application.hire',
    hrPeopleMutationResultSchema,
  ],
  [
    'POST',
  ...
  [
    'POST',
    `/hr-people/employees/${id}/skills`,
    'hr-people.employee.skills',
    hrPeopleMutationResultSchema,
  ],
  [
    'POST',
    '/hr-people/training-courses',
    'hr-people.training-courses',
    hrPeopleMutationResultSchema,
  ],
  [
    'POST',
    `/hr-people/training-courses/${id}/sessions`,
    'hr-people.training-course.sessions',
    hrPeopleMutationResultSchema,
  ],
  [
    'POST',
    `/hr-people/training-sessions/${id}/enrollments`,
    'hr-people.training-session.enrollments',
    hrPeopleMutationResultSchema,
  ],
  [
    'PATCH',
    `/hr-people/training-enrollments/${id}`,
    'hr-people.training-enrollment.detail',
    hrPeopleMutationResultSchema,
  ],
  [
    'POST',
  ...
  [
    'POST',
    `/hr-people/employees/${id}/certifications`,
    'hr-people.employee.certifications',
    hrPeopleMutationResultSchema,
  ],
  [
    'POST',
    '/hr-people/review-campaigns',
    'hr-people.review-campaigns',
    hrPeopleMutationResultSchema,
  ],
  [
  ...
  [
    'PATCH',
    `/hr-people/reviews/${id}`,
    'hr-people.review.detail',
    hrPeopleMutationResultSchema,
  ],
  [
    'POST',
    `/hr-people/reviews/${id}/objectives`,
    'hr-people.review.objectives',
    hrPeopleMutationResultSchema,
  ],
] as const;
