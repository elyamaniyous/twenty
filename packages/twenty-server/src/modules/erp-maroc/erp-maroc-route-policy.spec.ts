...
const approvedRoutes = [
  ...
  [
    'POST',
    `/procurement/requests/${id}/sourcing-events`,
    'procurement.request.createEvent',
    erpSourcingEventSchema,
  ],
  [
    'GET',
  ...
  [
    'GET',
    `/procurement/sourcing-events/${id}`,
    'procurement.event.detail',
    erpSourcingEventSchema,
  ],
  [
    'POST',
    `/procurement/sourcing-events/${id}/open`,
    'procurement.event.open',
    erpSourcingEventSchema,
  ],
  [
    'POST',
    `/procurement/sourcing-events/${id}/bids`,
    'procurement.event.bids',
    erpSourcingEventSchema,
  ],
  [
    'POST',
    `/procurement/sourcing-events/${id}/close`,
    'procurement.event.close',
    erpSourcingEventSchema,
  ],
  [
    'POST',
    `/procurement/sourcing-events/${id}/award`,
    'procurement.event.award',
    erpSourcingEventSchema,
  ],
  [
    'GET',
