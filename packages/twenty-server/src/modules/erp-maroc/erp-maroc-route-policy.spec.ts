...
const requiredIdempotencyRoutes = new Set([
  ...
  'POST /hr-core/access/self-service-links',
  'POST /hr-self-service/leave-requests',
  `PATCH /hr-self-service/leave-requests/${id}/evidence`,
  `PATCH /hr-self-service/leave-requests/${id}/cancel`,
  'POST /hr-self-service/time-correction-requests',
  `PATCH /hr-self-service/time-correction-requests/${id}/evidence`,
...
const approvedRoutes = [
  ...
  [
    'POST',
    '/hr-core/access/self-service-links',
    'hr-core.access.self-service-links',
    hrEmployeeSelfServiceAccessSchema,
  ],
  [
  ...
  [
    'GET',
    `/hr-self-service/documents/${id}/content`,
    'hr-self-service.document.content',
    hrDocumentContentSchema,
  ],
  [
    'GET',
    `/hr-self-service/payslips/${id}/pdf`,
    'hr-self-service.payslip.pdf',
    hrEmployeeSelfServicePayslipDocumentSchema,
  ],
  [
    'POST',
    '/hr-self-service/leave-requests',
    'hr-self-service.leave-requests',
    hrLeaveRequestSchema,
  ],
  [
    'PATCH',
    `/hr-self-service/leave-requests/${id}/evidence`,
    'hr-self-service.leave-request.evidence',
    hrLeaveRequestSchema,
  ],
  [
    'PATCH',
    `/hr-self-service/leave-requests/${id}/cancel`,
    'hr-self-service.leave-request.cancel',
    hrLeaveRequestSchema,
  ],
  [
    'POST',
  ...
  [
    'PATCH',
    `/hr-self-service/time-correction-requests/${id}/evidence`,
