...
const routes: ErpMarocRoute[] = [
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrEmployeeSelfServiceLeaveRequests,
    method: 'POST',
    pattern: exact('/hr-self-service/leave-requests'),
    build: staticBuilder(erpMarocUpstreamRoutes.hrSelfService.leaveRequests),
    queryKeys: noQuery,
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrEmployeeSelfServiceLeaveEvidence,
    method: 'PATCH',
    pattern: action('hr-self-service/leave-requests', 'evidence'),
    build: idBuilder(erpMarocUpstreamRoutes.hrSelfService.leaveEvidence),
    queryKeys: noQuery,
    responseSchema: hrLeaveRequestSchema,
    kind: 'json',
    idempotency: 'required',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrEmployeeSelfServiceLeaveCancel,
    method: 'PATCH',
    pattern: action('hr-self-service/leave-requests', 'cancel'),
    build: idBuilder(erpMarocUpstreamRoutes.hrSelfService.leaveCancel),
    queryKeys: noQuery,
    responseSchema: hrLeaveRequestSchema,
    kind: 'json',
    idempotency: 'required',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrEmployeeSelfServiceTimeCorrections,
    method: 'POST',
    pattern: exact('/hr-self-service/time-correction-requests'),
    build: staticBuilder(
      erpMarocUpstreamRoutes.hrSelfService.timeCorrectionRequests,
    ),
    queryKeys: noQuery,
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrEmployeeSelfServiceTimeCorrectionEvidence,
    method: 'PATCH',
    pattern: action('hr-self-service/time-correction-requests', 'evidence'),
    build: idBuilder(
      erpMarocUpstreamRoutes.hrSelfService.timeCorrectionEvidence,
    ),
    queryKeys: noQuery,
    responseSchema: hrTimeEntryCorrectionRequestSchema,
    kind: 'json',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleWorkspace,
    method: 'GET',
    pattern: exact('/hr-people/workspace'),
    build: staticBuilder(erpMarocUpstreamRoutes.hrPeople.workspace),
    queryKeys: noQuery,
    responseSchema: hrPeopleWorkspaceSchema,
    kind: 'json',
    idempotency: 'forbidden',
  }),
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleChangeRequestDecision,
    method: 'PATCH',
    pattern: action('hr-people/change-requests', 'decision'),
    build: idBuilder(erpMarocUpstreamRoutes.hrPeople.changeRequestDecision),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'forbidden',
  }),
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleAttestationDecision,
    method: 'PATCH',
    pattern: action('hr-people/attestations', 'decision'),
    build: idBuilder(erpMarocUpstreamRoutes.hrPeople.attestationDecision),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'forbidden',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleNotificationRetry,
    method: 'POST',
    pattern: action('hr-people/notifications', 'retry'),
    build: idBuilder(erpMarocUpstreamRoutes.hrPeople.notificationRetry),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'required',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleJobOpenings,
    method: 'POST',
    pattern: exact('/hr-people/job-openings'),
    build: staticBuilder(erpMarocUpstreamRoutes.hrPeople.jobOpenings),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'required',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleJobOpeningDetail,
    method: 'PATCH',
    pattern: detail('hr-people/job-openings'),
    build: idBuilder(erpMarocUpstreamRoutes.hrPeople.jobOpening),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'forbidden',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleCandidates,
    method: 'POST',
    pattern: exact('/hr-people/candidates'),
    build: staticBuilder(erpMarocUpstreamRoutes.hrPeople.candidates),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'required',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleApplications,
    method: 'POST',
    pattern: exact('/hr-people/applications'),
    build: staticBuilder(erpMarocUpstreamRoutes.hrPeople.applications),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'required',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleApplicationDetail,
    method: 'PATCH',
    pattern: detail('hr-people/applications'),
    build: idBuilder(erpMarocUpstreamRoutes.hrPeople.application),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'forbidden',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleApplicationInterviews,
    method: 'POST',
    pattern: action('hr-people/applications', 'interviews'),
    build: idBuilder(erpMarocUpstreamRoutes.hrPeople.applicationInterviews),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'required',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleInterviewDetail,
    method: 'PATCH',
    pattern: detail('hr-people/interviews'),
    build: idBuilder(erpMarocUpstreamRoutes.hrPeople.interview),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'forbidden',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleApplicationOffers,
    method: 'POST',
    pattern: action('hr-people/applications', 'offers'),
    build: idBuilder(erpMarocUpstreamRoutes.hrPeople.applicationOffers),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'required',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleOfferDetail,
    method: 'PATCH',
    pattern: detail('hr-people/offers'),
    build: idBuilder(erpMarocUpstreamRoutes.hrPeople.offer),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'forbidden',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleApplicationHire,
    method: 'POST',
    pattern: action('hr-people/applications', 'hire'),
    build: idBuilder(erpMarocUpstreamRoutes.hrPeople.applicationHire),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'required',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleSkills,
    method: 'POST',
    pattern: exact('/hr-people/skills'),
    build: staticBuilder(erpMarocUpstreamRoutes.hrPeople.skills),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'required',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleEmployeeSkills,
    method: 'POST',
    pattern: action('hr-people/employees', 'skills'),
    build: idBuilder(erpMarocUpstreamRoutes.hrPeople.employeeSkills),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'required',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleTrainingCourses,
    method: 'POST',
    pattern: exact('/hr-people/training-courses'),
    build: staticBuilder(erpMarocUpstreamRoutes.hrPeople.trainingCourses),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'required',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleTrainingCourseSessions,
    method: 'POST',
    pattern: action('hr-people/training-courses', 'sessions'),
    build: idBuilder(erpMarocUpstreamRoutes.hrPeople.trainingCourseSessions),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'required',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleTrainingSessionEnrollments,
    method: 'POST',
    pattern: action('hr-people/training-sessions', 'enrollments'),
    build: idBuilder(
      erpMarocUpstreamRoutes.hrPeople.trainingSessionEnrollments,
    ),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleTrainingEnrollmentDetail,
    method: 'PATCH',
    pattern: detail('hr-people/training-enrollments'),
    build: idBuilder(erpMarocUpstreamRoutes.hrPeople.trainingEnrollment),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'forbidden',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleCertifications,
    method: 'POST',
    pattern: exact('/hr-people/certifications'),
    build: staticBuilder(erpMarocUpstreamRoutes.hrPeople.certifications),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'required',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleEmployeeCertifications,
    method: 'POST',
    pattern: action('hr-people/employees', 'certifications'),
    build: idBuilder(erpMarocUpstreamRoutes.hrPeople.employeeCertifications),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'required',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleReviewCampaigns,
    method: 'POST',
    pattern: exact('/hr-people/review-campaigns'),
    build: staticBuilder(erpMarocUpstreamRoutes.hrPeople.reviewCampaigns),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'required',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleReviews,
    method: 'POST',
    pattern: exact('/hr-people/reviews'),
    build: staticBuilder(erpMarocUpstreamRoutes.hrPeople.reviews),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'required',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleReviewDetail,
    method: 'PATCH',
    pattern: detail('hr-people/reviews'),
    build: idBuilder(erpMarocUpstreamRoutes.hrPeople.review),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'forbidden',
  ...
  defineRoute({
    routeId: erpMarocRouteIds.hrPeopleReviewObjectives,
    method: 'POST',
    pattern: action('hr-people/reviews', 'objectives'),
    build: idBuilder(erpMarocUpstreamRoutes.hrPeople.reviewObjectives),
    queryKeys: noQuery,
    responseSchema: hrPeopleMutationResultSchema,
    kind: 'json',
    idempotency: 'required',
